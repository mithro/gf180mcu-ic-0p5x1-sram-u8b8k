...
// Chip: gf180mcu_ic_0p5x1_sram_u8b8k
...
module gf180mcu_ic_0p5x1_sram_u8b8k_sram_array (
    ...
    input  wire [12:0]       addr,      // Address bus
    ...
    assign sram_sel = addr[12:9];
    assign sram_addr = addr[8:0];

    // SRAM enable signals (directly from address decoder)
    wire [15:0] sram_ce_n;
    assign sram_ce_n[0] = ce_n | (sram_sel != 4'd0);
    assign sram_ce_n[1] = ce_n | (sram_sel != 4'd1);
    assign sram_ce_n[2] = ce_n | (sram_sel != 4'd2);
    assign sram_ce_n[3] = ce_n | (sram_sel != 4'd3);
    assign sram_ce_n[4] = ce_n | (sram_sel != 4'd4);
    assign sram_ce_n[5] = ce_n | (sram_sel != 4'd5);
    assign sram_ce_n[6] = ce_n | (sram_sel != 4'd6);
    assign sram_ce_n[7] = ce_n | (sram_sel != 4'd7);
    assign sram_ce_n[8] = ce_n | (sram_sel != 4'd8);
    assign sram_ce_n[9] = ce_n | (sram_sel != 4'd9);
    assign sram_ce_n[10] = ce_n | (sram_sel != 4'd10);
    assign sram_ce_n[11] = ce_n | (sram_sel != 4'd11);
    assign sram_ce_n[12] = ce_n | (sram_sel != 4'd12);
    assign sram_ce_n[13] = ce_n | (sram_sel != 4'd13);
    assign sram_ce_n[14] = ce_n | (sram_sel != 4'd14);
    assign sram_ce_n[15] = ce_n | (sram_sel != 4'd15);
    ...
    always @(*) begin
        case (sram_sel)
            4'd0: dout_mux = sram_dout_0;
            4'd1: dout_mux = sram_dout_1;
            4'd2: dout_mux = sram_dout_2;
            4'd3: dout_mux = sram_dout_3;
            4'd4: dout_mux = sram_dout_4;
            4'd5: dout_mux = sram_dout_5;
            4'd6: dout_mux = sram_dout_6;
            4'd7: dout_mux = sram_dout_7;
            4'd8: dout_mux = sram_dout_8;
            4'd9: dout_mux = sram_dout_9;
            4'd10: dout_mux = sram_dout_10;
            4'd11: dout_mux = sram_dout_11;
            4'd12: dout_mux = sram_dout_12;
            4'd13: dout_mux = sram_dout_13;
            4'd14: dout_mux = sram_dout_14;
            4'd15: dout_mux = sram_dout_15;

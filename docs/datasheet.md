# gf180mcu_ic_0p5x1_sram_u8b8k Datasheet

GF180MCU 0.5x1 SRAM Test Chip - 8KB unified 8-bit bus
## General Description

gf180mcu_ic_0p5x1_sram_u8b8k is an SRAM-based memory chip designed for the GF180MCU process.
It provides 8192 words of 8-bit storage using 16
embedded SRAM macros.

## Features

- 8192 bytes (65536 bits) total capacity
- 13-bit address bus
- 8-bit data bus
...
| addr[12:0] | Input | 13 | CMOS | Address bus |
...
The memory is organized as 8192 words of 8 bits each.
The address space spans from 0x0000 to 0x1FFF.

Internal organization:
- 16 SRAM macros (pdk)
- Each macro: 512 x 8-bit
- Grid: 2 columns x 8 rows
...
Generated configuration: gf180mcu_ic_0p5x1_sram_u8b8k
- Slot: 0p5x1
- SRAM count: 16

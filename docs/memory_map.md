# gf180mcu_ic_0p5x1_sram_u8b8k Memory Map

## Overview

| Parameter | Value |
|-----------|-------|
| Total Capacity | 8192 words |
| Data Width | 8 bits |
...
The memory consists of 16 SRAM macros, each providing
512 x 8-bit storage.
...
Address Bus [12:0]
     |
     +---> Upper bits [12:9] --> SRAM Select (16 blocks)
     |
...
2. Out-of-range addresses (>= 0x2000) are undefined

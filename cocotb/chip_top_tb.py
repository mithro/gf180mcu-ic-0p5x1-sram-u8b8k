...
"""Chip-level testbench for gf180mcu_ic_0p5x1_sram_u8b8k.
...
slot = os.getenv("SLOT", "0p5x1")

hdl_toplevel = "gf180mcu_ic_0p5x1_sram_u8b8k_top"
...
async def test_startup(dut):
    ...
    logger = logging.getLogger("gf180mcu_ic_0p5x1_sram_u8b8k_tb")
...
def chip_top_runner():
    ...
    if gl:
        ...
        sources.append(proj_path / "../src/gf180mcu_ic_0p5x1_sram_u8b8k_top.sv")
        sources.append(proj_path / "../src/gf180mcu_ic_0p5x1_sram_u8b8k_core.sv")
        sources.append(proj_path / "../src/gf180mcu_ic_0p5x1_sram_u8b8k_sram_array.sv")
